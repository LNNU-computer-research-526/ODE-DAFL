...
parser.add_argument('--dataset', type=str, default='AR', choices=['MNIST', 'cifar10', 'cifar100','AR'])
...
class ARDataset(Dataset):
    def __init__(self,list_train,list_test,transform = None,train = True):
        self.root = 'C:\\Users\\ASUS\\Desktop\\AR'
...
if opt.dataset == 'AR':
    ...
    train_root = 'C:\\Users\\ASUS\\Desktop\\AR//train.txt'
    test_root = 'C:\\Users\\ASUS\\Desktop\\AR//test.txt'
    list_train = []
    list_test = []
